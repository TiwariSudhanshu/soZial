...
const EditProfileComponent = () => {
  ...
  return (
    <div id="main-content" className="h-screen w-full ml-[-5vmax] bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100 flex flex-col items-center p-8 overflow-x-hidden">
      {/* Header */}
      ...
      {/* Content Section */}
      <div className="w-full max-w-3xl bg-white dark:bg-gray-900 rounded-lg p-6 shadow-md">
        {activeSection === "profile" ? (
  ...
  <label
    htmlFor="avatar"
    className="block text-sm text-gray-500 cursor-pointer bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-300 py-1 px-2 rounded-lg"
  >
   Choose File
  </label>
  <input
  ...
  />
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-2 rounded-lg bg-gray-200 dark:bg-gray-700 outline-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                value={formData.bio}
                onChange={handleChange}
                className="w-full p-2 rounded-lg bg-gray-200 dark:bg-gray-700 outline-none resize-none"
                rows="3"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                id="coverImage"
                  name="coverImage"
                  onChange={handleFileChange}
                className="text-sm text-gray-500 file:mr-4 file:py-1 file:px-2 file:rounded-lg file:border-0 file:bg-gray-300 dark:file:bg-gray-600 file:text-gray-700 dark:file:text-gray-300"
              />
            </div>
            {loader ? (
